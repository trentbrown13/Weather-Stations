...
/************************************************************************************
 another attempt at using OTA with sleep. Last attempt was with node-red wich I am still
 interested in but using apache + php and a "manifest" file may be better in the long run.

 An example manifest file from a more complicated openwrt device:
 {
  "firmware": [
    {
      "version": "0.0.0.2",
